...
public class GameController : MonoBehaviour
{
	...
	//		CreatePiece(55, x, Bin0Position.y);
	...
	//		x = Bin0Position.x + 4 * BinXSpacing;
	//		CreatePiece(3, x, Bin0Position.y);
	//		CreatePiece(12, x, Bin0Position.y + BinPieceYSpacing);
	//		CreatePiece(49, x, Bin0Position.y + 2 * BinPieceYSpacing);
	//		CreatePiece(36, x, Bin0Position.y + 3 * BinPieceYSpacing);
	//	}
	//	catch (Exception ex)
	//	{
	...
	{
		GameObject selectedPiece = Instantiate(_config.PiecePrefab);
